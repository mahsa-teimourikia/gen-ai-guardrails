...
test("complete answer key earns 100 percent", () => { const answers = Object.fromEntries(questions.map(q => [q.id, q.correct])); const result = gradeQuiz(questions, answers); assert.equal(result.percent, 100); assert.equal(result.correct, 18); });
